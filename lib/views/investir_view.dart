...
class InvestirView extends StatefulWidget {
  const InvestirView({super.key});

  @override
  State<InvestirView> createState() => _InvestirViewState();
}

class _InvestirViewState extends State<InvestirView> {
  @override
  void initState() {
    super.initState();
